...
@Slf4j
@Service
public class BillService implements BillRest {
...
//		log.info("Inside generateReport");
		...
		try {
			...
			if (validateRequestMap(requestMap)) {
				...
				Paragraph chunk = new Paragraph("Engineer's Cafe", getFont("Header"));
...
//		log.info();
		System.out.println("Inside getPdf : requestMap {}"+requestMap);
		try {
